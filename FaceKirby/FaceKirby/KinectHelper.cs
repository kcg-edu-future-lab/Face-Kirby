...
namespace FaceKirby
{
    ...
    public abstract class BitmapInfo
    {
        ...
        public static ColorBitmapInfo ForColor(int width, int height)
        {
            return new ColorBitmapInfo(width, height, PixelFormats.Bgr32, 4);
        }
    ...
    public class ColorBitmapInfo : BitmapInfo
    {
        ...
        public ColorBitmapInfo(int width, int height, PixelFormat pixelFormat, int bytesPerPixel)
        {
